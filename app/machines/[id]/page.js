        ...
        <div className="grid lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div>
              ...
              <div className="mt-4">
                <p className="text-xs text-[#434042] mb-1">Prix indicatif</p>
                <p className="text-4xl font-black text-[#e46a33]">
                  {machine.price?.toLocaleString('fr-DZ')} <span className="text-xl text-[#e46a33]">DZD</span>
                </p>
              </div>
            </div>
            ...
            {machine.specsObj && Object.keys(machine.specsObj).length > 0 && (
              <div className="card p-6">
                <h2 className="font-bold text-[#141313] mb-4">Spécifications techniques</h2>
                <div className="grid sm:grid-cols-2 gap-3">
                  {Object.entries(machine.specsObj).map(([k, v], i) => (
                    <div key={i} className="flex justify-between py-2 border-b border-[#e9e9e9]">
                      <span className="text-[#8c8b8b] text-sm">{k}</span>
                      <span className="text-[#141313] text-sm font-medium">{v}</span>
                    </div>
                  ))}
                </div>
              </div>
            ...
            {machine.specs && !machine.specsObj && (
              <div className="card p-6">
                <h2 className="font-bold text-[#141313] mb-4">Spécifications techniques</h2>
                <p className="text-[#8c8b8b] text-sm whitespace-pre-line">{machine.specs}</p>
              </div>
            )}
          </div>
          ...
          <div className="space-y-6">
            ...
            {/* Vendeur */}
            <div className="card p-6">
              <h3 className="font-bold text-[#141313] mb-4">Vendeur</h3>
              <div className="flex items-center gap-3 mb-4">
                <div className="w-12 h-12 rounded-full bg-[#f9f9f8] border border-[#e9e9e9] flex items-center justify-center text-[#e46a33] font-black text-lg">
                  {(machine.seller?.name || 'V')[0]}
                </div>
                <div>
                  <p className="font-semibold text-[#141313]">{machine.seller?.name || 'Vendeur'}</p>
              ...
              <div className="space-y-2 mb-4 text-sm text-[#8c8b8b]">
              ...
              {!sent ? (
                ...
                <div className="bg-green-900/20 border border-green-700/40 rounded-xl p-4 text-center">
                  ...
                  <p className="text-[#8c8b8b] text-xs mt-1">Le vendeur vous répondra sous 24h.</p>
                </div>
              )}
            </div>
            ...
            <div className="card p-6 text-center" style={{ background: 'linear-gradient(135deg, #0f0a1a, #1a0a2e)' }}>
              <div className="w-10 h-10 rounded-xl bg-[#e46a33]/10 border border-[#e9e9e9] mx-auto mb-2 flex items-center justify-center">
                <span className="text-[#e46a33] font-black text-sm">AI</span>
              </div>
              <h3 className="font-semibold text-[#141313] mb-2">Pas sûr de votre choix ?</h3>
              <p className="text-[#8c8b8b] text-xs mb-4">MachiBot compare les machines et vous conseille.</p>
            ...
            <div className="card p-6">
              <h3 className="font-bold text-[#141313] mb-2">Besoin d'un expert {secteur} ?</h3>
              <p className="text-[#8c8b8b] text-sm mb-4 leading-relaxed">
