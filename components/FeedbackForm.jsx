  ...
  if (done) {
    return (
      <div className="card p-8 text-center">
        ...
        <p className="text-gray-400 text-sm">Votre témoignage sera publié après validation par notre équipe.</p>
      </div>
    )
  }
  ...
  return (
    <form onSubmit={handleSubmit} className="card p-6 space-y-4">
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        ...
        <div>
          <label className="text-gray-400 text-sm mb-1 block">Poste / Entreprise</label>
      ...
      <div>
        <label className="text-gray-400 text-sm mb-1 block">Votre avis *</label>
      ...
      <p className="text-gray-600 text-xs text-center">Votre avis sera publié après modération.</p>
    </form>
  )
}
